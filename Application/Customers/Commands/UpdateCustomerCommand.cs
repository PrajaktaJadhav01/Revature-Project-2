...
public class UpdateCustomerCommandHandler
{
    ...
    public Task<Customer?> HandleAsync(UpdateCustomerCommand command, CancellationToken cancellationToken = default)
    {
        ...
        return _customerService.UpdateCustomerAsync(customer, cancellationToken);
    }
}
